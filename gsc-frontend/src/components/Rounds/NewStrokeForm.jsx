  ...
  return (
      ...
      <div className="rounded-t-lg border border-solid border-white shadow-md">
        ...
        <div className="px-3 grid grid-cols-4 gap-2 pb-2 text-white">
          <div></div>
          <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem] col-span-3">
            <input
              ...
              type="checkbox"
              value={newStroke.is_penalty}
              id="isPenaltyCheck"
              checked={newStroke.is_penalty}
        ...
        {!newStroke.is_penalty && (
          <>
            <h1 className="text-white pl-2 my-3">stroke details</h1>
            <div className="px-3 grid grid-cols-4 gap-2 pb-2 text-white">
              <h1>club</h1>
            ...
            <h1 className="text-white pl-2 my-3">stroke analysis</h1>
