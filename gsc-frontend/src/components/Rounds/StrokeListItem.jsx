...
const StrokeListItem = ({ stroke, round_id, round_record_id }) => {
  ...
  return (
    <div className="w-full pl-4 px-2 py-2 flex">
      <div className="flex flex-col gap">
        ...
        <p className="pl-2 italic text-xs text-gray-300">{stroke.club.name}</p>
      </div>
      <div className="grow flex gap-2 justify-end items-center">
        <div className="triple-dot relative" onClick={() => setShowMenu(true)}>
          <svg
          ...
          >
            <div className="flex flex-col divide-y divide-slate-500/50">
              ...
              <div className="grid grid-cols-4 items-center py-2" onClick={deleteStroke}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  className="w-5 h-5 fill-slate-500"
